		...
		<form action="UpdateUserServlet" method="POST">
			<table align="center" cellpadding="10">
				...
				<tr>
					<td>User mail</td>
					<td>
						<input type="text" name="userMail" maxlength="30" value="<%=u.getUserMail()%>"/> 
				...
				<tr>
					<td>User Name</td>
					<td>
						<input type="text" name="userName" maxlength="30" value="<%=u.getUserName()%>"/>
						(max 30 characters a-z and A-Z)
					</td>
				</tr>
				<tr>
					<td>Password</td>
					<td>
						<input type="password" name="password" maxlength="100" placeholder="Enter the new password"/>
					</td>
				</tr>
				<tr>

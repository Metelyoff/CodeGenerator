...
<html>
	...
	<body>
		...
		if(currentUser==null){
			...
			/* List<String> lockKeys=ls.getCodeGeneratorByLockId(lock).getList(); */
		...
		<nav>
		    <ul class="main-menu">
		        ...
		        <li>
		        	<a href="view_user_lock_keys.jsp?userId=<%=currentUser.getIdUser()%>">Keys(<%-- <%=lockKeys.size()%> --%>)</a>
		        	<%-- <ul class="sub-menu">
		...
		<div class="container">
			<h1>Generate key for <%=lock.getLockName()%> lock, count keys (<%=size%>)</h1>
